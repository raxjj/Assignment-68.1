...
export default function Signup(){
    const signupSchema= Yup.object().shape({
      ...
      const {handleSubmit,values,handleChange,errors,
        ...
        onSubmit:callLoginApi,validationSchema:signupSchema
      })
    ...
    return(
        ...
        <div className="flex justify-center bg-gray-300 h-screen items-center">
          <div className="bg-gradient-to-br from-purple-600 via-blue-500 to-indigo-400 rounded-lg py-10 px-20">
                <h1 className="text-white font-bold justify-center text-center mb-5 text-2xl">Create new account </h1>
                <div>
                    <form action=""
                    ...
                    <div className="flex justify-end">
                        ...
                        <button className="hover:underline hover:text-white"><Link to="/login">login</Link></button>
                    </div>
